...
const Header = () => {
    ...
    useEffect(() => {
        ...
        if (sidebar) {
              sidebar.classList.add('open');   // add close class
                sidebar.classList.remove('close'); // remove open class
                ...
                <nav className="navbar navbar-expand-sm d-md-block bg-white w-100">
                    <div className="container-fluid">
                        <div className="d-flex w-100 align-items-center">
                            <div>
                                <button type="button" className="sidebar-toggle-btn btn" id="sidebar-toggle-btn" onClick={handleSidebarOpen}>
                                ...
                                <div className="row w-100 align-items-center">
                                    ...
                                    <div className="col-2 border-start border-end d-none d-lg-block">
                                        <div className="d-flex justify-content-center">
                                            <a className="btn btn-outline-primary px-3 py-2 rounded-5 h-auto" href="https://digitalindialearning.com/">
